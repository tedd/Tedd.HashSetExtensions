...
with open("src/Tedd.HashSetExtensions.Tests/AegisTest.cs", "r") as f:
    content = f.read()

# the goal is to make it use Theory and MemberData/InlineData and ArrayPool
...
with open("src/Tedd.HashSetExtensions.Tests/AegisTest.cs", "w") as f:
    f.write(new_content)
